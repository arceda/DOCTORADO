...
void init() {
	...
	fragmentshader = initshaders(GL_FRAGMENT_SHADER, "D://Documents//Manuel//UNSA//Docencia//2020//CG//Laboratorio//Projects//OpenGL//GLFW_GLAD_GLUT_GLEW_cmake_project_Base//src//hw1//shaders//light.frag.glsl");
#endif
